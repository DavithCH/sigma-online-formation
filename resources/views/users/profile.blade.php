...
<div class="text-lg">
    ...
    <div>
        ...
        <div class="w-96 max-h-96">
            <img class="object-cover w-full h-50"
                src="{{!str_contains($user['image'], 'users/') ? $user['image']  : asset('storage/'.$user['image'])}}">
        </div>
        @endif
    </div>
</div>
...
<div class="mt-3">
    ...
    <a class="btn btn-warning" href="{{ route('editPassword', $user['id']) }}">Change password</a>
</div>
